...
public class IS_VarDec extends AbstractInterpreterExecutor {
    ...
    @PotentiallyBroken("The line that checks for 'exists locally' explicitly states that it doesn't check through parent " +
                       "scopes which I am pretty sure will be a problem if the parent scope defines the same variable.")
    ...
    public static void run(EnvisionInterpreter interpreter, Stmt_VarDef s) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            // ----- this line is potentially broken -----
