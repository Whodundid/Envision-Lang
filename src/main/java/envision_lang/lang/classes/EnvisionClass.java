...
/**
 * The EnvisionClass is the primary component for which all EnvisionObject
 * instances are instantiated from. EnvisionClass, while technically not an
 * object in itself, provides the underlying blueprint structure for which
 * all objects are created from.
 * 
 * <p>
 * Every EnvisionObject will have a specific, singular, root parent class
 * from which it has been instantiated from.
 * 
 * <p>
 * Classes contain their own static scopes which can house their own static
 * fields/methods/classes/etc. This scope is ultimately derived from the
 * over-arching scope from which this class was originally declared within.
 * This means that any values native to the original defining scope are
 * also visible to this class's static scope in some capacity.
 * 
 * <p>
 * A class must define a specific object type that represents the type of
 * object instances it is capable of creating. As such, a datatype must be
 * passed during class instantiation. This datatype will be used as the
 * underlying datatype for all instances.
 * 
 * @author Hunter Bragg
 */
public class EnvisionClass extends EnvisionObject {
    ...
    /**
     * Denotes whether or not the the natives for this class have been
     * constructed.
     */
    ...
    /**
     * True by default but can be set to false to account for abstract
    ...
    /**
     * The entire list of non-static statements that have been declared
     * within this class declaration. These statements are used by class
     * constructs to help improve instance creation.
     */
    protected EList<ParsedStatement> bodyStatements = new EArrayList<>();
    
    /**
     * The entire list of constructor (initializer) statements that have
     * been declared within this class declaration.
     */
    ...
    @Override
    /** Special override for classes to always return themselves. */
    ...
    /**
     * Called at class-interpreter instantiation to register static class
     * members outside of the internal construction phase. This approach
     * prevents an infinite instantiation loop.
     */
    ...
    /**
     * Adds a specific constructor to this object. If no constructor was
     * present before, this new constructor will override the default
     ...
     * 
     * All inheriting classes must directly override this method to specify
     * the exact process of the child's object instantiation.
     * 
     * @param  interpreter The active working interpreter
     * @param  args        Any arguments to be passed to the new object
     *                     instance
    ...
    /**
     * Default class construction procedure. This path will only be taken
     * if a ClassConstruct is not present.
     * 
     * @param  interpreter The active working interpreter
     * @param  args        Any arguments to be passed to the new object
     *                     instance
    ...
    /**
     * Internal function used by native object classes to define all
     * static/member object functions, variables, etc.
     * <p>
     * Note: Class object creation can in theory bypass this method but
     * there will not be any scope members defined on the child object.
     * Could be useful if a specific object member should not have
     * accessible child members.
     * 
    ...
    /**
     * Abstract classes cannot be directly instantiated and require a
     * non-abstract inheriting class to implement.
     * 
     * @return True if this is an abstract class.
     */
    public boolean isAbstract() { return modifierHandler.isAbstract(); }
    
    /**
     * Returns true if this object can actually be instantiated. The only
     * reason this should ever return false is if this object represents an
     ...
     * static fields/functions/classes/etc. that reside within this class's
     * scope are located within this
     * 
     * @return The static scope of this class.
     */
    public IScope getClassScope() { return staticScope; }
    ...
    /**
     * Used to manually set whether or not this object should be
     * instantiable. Abstract classes and interfaces will want to set
     * insantiability to false to prevent an abstract class instance from
     * being created.
     * 
