...
import envision.parser.statements.statementParsers.PS_Method;
...
public abstract class GenericParser {
	...
	public static Statement declaration(boolean inMethod) {
		...
		case FUNC_DEF: 			return PS_Method.methodDeclaration(false, false, dec);
		case INIT_DEF:			return PS_Method.methodDeclaration(true, false, dec);
		case OPERATOR_DEF:  	return PS_Method.methodDeclaration(false, true, dec);
