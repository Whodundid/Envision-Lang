...
public class EnvisionString extends EnvisionVariable {
	...
	public EnvisionString() { super(EnvisionDataType.STRING, ""); }
	public EnvisionString(String valueIn) { this("noname", valueIn); }
	public EnvisionString(String nameIn, String valueIn) {
		super(EnvisionDataType.STRING, nameIn, valueIn);
	}
	
	public EnvisionString(Object in) { this(in.toString()); }
	public EnvisionString(EnvisionObject in) { this(in.toString()); }
	...
	*/
	...
	protected void registerInternalMethods() {
		...
		im(new InternalMethod(STRING, "valueOf", OBJECT) { protected void body(Object[] a) { ret(of(a[0])); }});
		im(new InternalMethod(STRING, "get") { protected void body(Object[] a) { ret(get()); }});
		im(new InternalMethod(STRING, "set", OBJECT) { protected void body(Object[] a) { ret(set(String.valueOf(a[0]))); }});
	...
	public EnvisionList toList() {
		EnvisionList list = new EnvisionList(EnvisionDataType.CHAR);
		String s = (String) get();
